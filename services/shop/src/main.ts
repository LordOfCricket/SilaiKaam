...
const SERVICE_NAME = 'shop-service';
...
async function bootstrap() {
  ...
  await listenWithRetry(() => app.listen(env.SHOP_SERVICE_PORT), logger, env.SHOP_SERVICE_PORT);
  logger.info(`listening on port ${env.SHOP_SERVICE_PORT}`);
}
